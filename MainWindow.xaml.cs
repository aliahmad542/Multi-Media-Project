...
public partial class MainWindow : System.Windows.Window
{
    ...
    private void RotateY_Click(object sender, RoutedEventArgs e)
     {
         cameraAlpha += 15; UpdateCamera();
      }
    private void RotateX_Click(object sender, RoutedEventArgs e) {
         cameraBeta += 10; UpdateCamera(); 
         }
    private void ZoomIn_Click(object sender, RoutedEventArgs e) {
        
         cameraRadius = Math.Max(3, cameraRadius - 0.5); UpdateCamera();
          }
    private void ZoomOut_Click(object sender, RoutedEventArgs e) {
        
         cameraRadius = Math.Min(15, cameraRadius + 0.5); UpdateCamera(); 
         }
    ...
    private void ApplyColorEffects() {
        ...
        try
        {
            ...
            if (CboColorSpace.SelectedIndex == 5) 
            {
                ...
                Mat bMat = bgrChannels[0];
                Mat gMat = bgrChannels[1]; 
                Mat rMat = bgrChannels[2];
                ...
                Mat maxRG = new();
                 Cv2.Max(rMat, gMat, maxRG);
                Mat maxRGB = new();
                 Cv2.Max(maxRG, bMat, maxRGB);
            ...
            {
                ColorConversionCodes code = CboColorSpace.SelectedIndex switch {
                    1=>ColorConversionCodes.BGR2HSV,
                    2=>ColorConversionCodes.BGR2YCrCb,
                    3=>ColorConversionCodes.BGR2Lab, 
                    4=>ColorConversionCodes.BGR2YUV,
    ...
    private void SliderColorCount_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e) {
        ...
        int k = (int)SliderColorCount.Value;
         TxtColorCount.Text = $"{k} Colors";
        Mat div = originalImage.Clone();
         Cv2.Divide(div, 256/k, div);
          Cv2.Multiply(div, 256/k, div);
        processedImage = div; 
        UpdateUI();
    }

    private void SliderComponent_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e) 
    => ApplyColorEffects();
    private void Channel_Toggle(object sender, RoutedEventArgs e) 
    => ApplyColorEffects();
    private void CboColorSpace_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e) 
    => ApplyColorEffects();
